  ...
  return (
    <div className="bg-[#fcfbf7] min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-8xl lg:text-[12rem] font-serif text-white leading-none tracking-tighter mb-8"
          >
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 md:py-40">
        ...
        <div className="mb-40">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-24 gap-12">
            <motion.div 
              ...
              className="max-w-2xl"
            >
              <h2 className="text-4xl md:text-7xl font-serif mb-8 text-stone-900 leading-tight">Signature Venues</h2>
              <p className="text-stone-500 text-lg md:text-xl font-light leading-relaxed">Each restaurant at {resort.name} offers a distinct atmosphere and menu, crafted by our award-winning international chefs using the freshest local and imported ingredients.</p>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
          ...
          <div className="space-y-32 md:space-y-64">
            {paginatedVenues.map((venue, i) => (
              <div key={i} className={`flex flex-col ${i % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-16 lg:gap-32 items-center`}>
                ...
                >
                  <h3 className="text-4xl md:text-6xl font-serif text-stone-900 leading-tight">{venue.name}</h3>
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center relative z-10">
            <div>
              ...
              <h2 className="text-4xl md:text-7xl font-serif mb-10 leading-tight">Curated Meal Plans</h2>
              <p className="text-stone-400 text-lg md:text-xl mb-16 leading-relaxed font-light">Whether you prefer the flexibility of Half Board or the worry-free luxury of our Crystal All-Inclusive plan, we have designed our offerings to suit your island lifestyle.</p>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-12 -left-12 bg-white p-10 rounded-[2rem] shadow-3xl hidden md:block">
                ...
                <p className="text-stone-900 font-serif text-xl italic">"Exquisite flavors, <br /> unforgettable views."</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-4xl md:text-7xl font-serif mb-8 text-stone-900">Ready to Taste Paradise?</h3>
