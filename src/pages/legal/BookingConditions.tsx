  ...
  return (
    <LegalPageLayout title="Booking Conditions & Disclaimers" lastUpdated="March 2026">
      <div className="space-y-12">
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">1. Price Validity</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">2. Accuracy of Information</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">3. Passport & Visa</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">4. Health & Safety</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">5. Special Requests</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">6. Complaints Procedure</h2>
          <div className="space-y-4">
