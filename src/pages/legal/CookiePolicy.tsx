      ...
      <div className="space-y-12">
        <section>
          ...
          <div className="space-y-4">
            <p>We use cookies to enhance your booking experience on ayada.tripmaldives.com. This policy explains what cookies are, how we use them, and how you can manage your preferences.</p>
          </div>
        </section>

        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">2. Cookie Inventory</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">3. Cookie Categorization</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">4. Managing Your Preferences</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">5. Third-Party Cookies</h2>
          <div className="space-y-4">
