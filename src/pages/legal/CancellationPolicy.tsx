  ...
  return (
    <LegalPageLayout title="Cancellation & Refund Policy" lastUpdated="March 2026">
      <div className="space-y-12">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">1. Standard Cancellation Timeline</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">2. Resort-Specific Policies</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">3. Modification Policy</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">4. Force Majeure</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">5. No-Show Policy</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">6. Refund Process</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">7. Travel Insurance Recommendation</h2>
          <div className="space-y-4">
