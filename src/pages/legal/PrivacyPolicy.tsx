  ...
  return (
    <LegalPageLayout title="Privacy Policy" lastUpdated="March 2026">
      <div className="space-y-12">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">1. Introduction</h2>
          <div className="space-y-4">
            <p>Maldives Serenity Travels ("we," "us," or "our") is committed to protecting your privacy. This policy explains how we collect, use, and safeguard your personal data when you use ayada.tripmaldives.com (the "Platform").</p>
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">2. Information We Collect</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">3. How We Use Your Information</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">4. Legal Basis for Processing (GDPR)</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">5. Data Sharing & Third Parties</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">6. Data Security</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">7. Your Rights</h2>
          <div className="space-y-4">
