  ...
  return (
    <LegalPageLayout title="Terms of Service" lastUpdated="March 2026">
      <div className="space-y-12">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">1. Definitions</h2>
          <ul className="list-disc pl-6 space-y-4">
            <li><strong>"Company," "we," "us," "our"</strong> refers to Maldives Serenity Travels.</li>
            <li><strong>"Platform"</strong> refers to the brand TripMaldives and the website ayada.tripmaldives.com.</li>
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">2. Booking Process & Contract Formation</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">3. Payments & Pricing</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">4. Cancellation & Refund Policy</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">5. Responsibilities & Liabilities</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">6. Intellectual Property</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-serif text-stone-900 mb-6">8. Modifications</h2>
          <div className="space-y-4">
