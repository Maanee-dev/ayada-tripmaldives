      ...
      <div className="relative h-[50vh] md:h-[70vh] -mx-6 md:-mx-12 lg:-mx-16 -mt-16 md:-mt-24 mb-12 md:mb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-stone-900/40 flex flex-col justify-end p-8 md:p-16 lg:p-24">
          <div className="max-w-7xl mx-auto w-full">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-9xl font-serif text-white mb-6 leading-[0.85] tracking-tighter">Excursions</h1>
          </div>
        </div>
      </div>
        ...
        <div className="mb-20">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-12 md:mb-16">
            <div className="max-w-3xl">
              <h2 className="text-4xl md:text-6xl font-serif mb-6 leading-tight text-stone-900">Explore the Wonders of the Atoll</h2>
              <p className="text-stone-600 text-base md:text-lg font-light leading-relaxed">
                From romantic sunset cruises to thrilling dolphin spotting adventures, our excursions are designed to help you discover the natural beauty and culture of the Maldives. Each journey is led by our experienced guides who share their deep knowledge of the local marine life and traditions.
              </p>
            </div>
          ...
          <div className="bg-stone-900 rounded-[2rem] md:rounded-[4rem] p-6 md:p-20 text-white shadow-2xl">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12 md:mb-16">
              <div className="flex items-center gap-4 md:gap-6">
                ...
                <div>
                  <h3 className="text-2xl md:text-5xl font-serif">Water Sports Price List</h3>
