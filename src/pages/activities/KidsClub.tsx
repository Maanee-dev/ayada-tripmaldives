...
import { Sun, Heart, Music, Zap, CheckCircle2, Star } from 'lucide-react';
...
export default function KidsClub({ resort }: KidsClubProps) {
  const activities = [
    {
      title: "Arts & Crafts",
      description: "Creative workshops for children to express their artistic side.",
      icon: Heart
    },
    {
      title: "Outdoor Games",
      description: "Fun and active games on the beach and in our playground.",
      icon: Sun
    },
    {
      title: "Movie Nights",
      description: "Weekly movie screenings under the stars.",
      icon: Music
    },
    {
      title: "Educational Fun",
      description: "Learning about the local marine life and environment.",
      icon: Zap
    }
  ];
    ...
    <div className="animate-in fade-in duration-700">
      ...
      <div className="relative h-[60vh] md:h-[70vh] -mx-6 md:-mx-12 lg:-mx-16 -mt-16 md:-mt-24 mb-16 md:mb-24 overflow-hidden">
        <img 
          ...
          alt="Kids Club Maldives"
          referrerPolicy="no-referrer"
        />
        <div className="absolute inset-0 bg-stone-900/40 flex flex-col justify-end p-6 md:p-16 lg:p-24">
          <div className="max-w-7xl mx-auto w-full">
            <p className="text-emerald-400 uppercase tracking-[0.4em] text-[10px] md:text-xs font-bold mb-4">Young Adventurers</p>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center mb-24">
          <div>
            <h2 className="text-3xl md:text-5xl font-serif mb-8 leading-tight">A World of Fun for Little Ones</h2>
            <p className="text-stone-500 text-lg font-light leading-relaxed mb-8">
              Our Zuzuu Kids Club offers a wide range of fun and educational activities for children of all ages, supervised by our professional team.
            </p>
            <div className="space-y-4">
              {['Professional Supervision', 'Safe Environment', 'Daily Activity Program', 'Educational Workshops'].map((item) => (
