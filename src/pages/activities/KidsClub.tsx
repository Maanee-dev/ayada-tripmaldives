    ...
    <div className="animate-in fade-in duration-700 bg-[#fdfcfb]">
      ...
      <div className="relative h-[60vh] md:h-[70vh] -mx-6 md:-mx-12 lg:-mx-16 -mt-16 md:-mt-24 mb-16 md:mb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-stone-900/30 flex flex-col justify-end p-6 md:p-16 lg:p-24">
          <div className="max-w-7xl mx-auto w-full">
            ...
            <h1 className="text-4xl md:text-7xl lg:text-9xl font-serif text-white mb-6 leading-[0.9] tracking-tighter">Zuzuu Kids Club</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-start mb-32">
          <div>
            <h2 className="text-3xl md:text-5xl font-serif mb-8 leading-tight text-stone-900">A World of Wonder</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-serif text-lg text-stone-900">Opening Hours</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-serif text-lg text-stone-900">Age Group</h4>
            ...
            <div className="bg-stone-50 p-8 rounded-[32px] border border-stone-100 mb-8">
              <h4 className="font-serif text-xl text-stone-900 mb-4">Good to Know</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {features.map((item, index) => (
              <div key={index} className="bg-white p-8 rounded-[32px] border border-stone-100 shadow-sm hover:shadow-md transition-all group">
                ...
                <h4 className="font-serif text-xl mb-3 text-stone-900">{item.title}</h4>
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-serif text-stone-900 mb-4">Our Facilities</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative h-80 rounded-[40px] overflow-hidden group">
              <img 
                src="https://images.unsplash.com/photo-1566454419290-28221f2951c6?auto=format&fit=crop&q=80&w=800" 
                className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                alt="Kids Pool"
                referrerPolicy="no-referrer"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-8">
                <h4 className="text-white font-serif text-2xl">Kids' Pool</h4>
            ...
            <div className="relative h-80 rounded-[40px] overflow-hidden group">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-8">
                <h4 className="text-white font-serif text-2xl">Playground</h4>
            ...
            <div className="relative h-80 rounded-[40px] overflow-hidden group">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-8">
                <h4 className="text-white font-serif text-2xl">Creative Stage</h4>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-stone-900 text-white p-12 rounded-[48px] flex flex-col justify-center">
              <h4 className="text-3xl font-serif mb-6">Attentive Care</h4>
              <p className="text-stone-400 font-light leading-relaxed mb-8">
                Our dedicated nanny room and professional team ensure that your little ones are cared for with the utmost attention, allowing you to relax knowing they are in safe hands.
              </p>
            ...
            <div className="bg-orange-500 text-white p-12 rounded-[48px] flex flex-col justify-center">
              <h4 className="text-3xl font-serif mb-6">Educational Insight</h4>
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-serif text-stone-900 mb-4">Weekly Activity Schedule</h3>
