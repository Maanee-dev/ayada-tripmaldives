  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-20">
      ...
      >
        ...
        <h1 className="text-4xl md:text-7xl font-serif mb-8 leading-tight tracking-tighter">Your Journey Begins</h1>
        
        <p className="text-stone-500 text-lg md:text-xl font-light leading-relaxed mb-12">
          Thank you for choosing TripMaldives. Your private quotation request for Ayada Maldives has been received. A luxury specialist will review your details and contact you within 24 hours.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          <div className="bg-stone-50 p-8 rounded-2xl border border-stone-100 text-left">
            ...
            <h3 className="font-serif text-xl mb-2">What's Next?</h3>
            <p className="text-sm text-stone-500 font-light leading-relaxed">
              We are checking real-time availability and exclusive offers for your selected dates to ensure you get the best possible rate.
            </p>
          </div>
          <div className="bg-emerald-50 p-8 rounded-2xl border border-emerald-100 text-left">
            ...
            <h3 className="font-serif text-xl mb-2">Need it Faster?</h3>
