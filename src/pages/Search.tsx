    ...
    <div className="min-h-screen py-20 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-serif mb-10">Search Results</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {results.map((item, index) => (
            <div key={index} className="group bg-white rounded-3xl border border-stone-100 overflow-hidden hover:shadow-2xl hover:shadow-stone-200/50 transition-all duration-500">
              ...
              <div className="p-8">
                <h3 className="text-xl font-serif mb-3 group-hover:text-emerald-600 transition-colors">{item.name}</h3>
