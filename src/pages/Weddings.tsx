...
import { Heart, Camera, Music, Utensils, CheckCircle2, Star, Ship, MapPin, Sparkles, Cake, Wine, Bath, Anchor, Camera as CameraIcon, FileText, ShoppingBag } from 'lucide-react';
  ...
  const locations = [
    {
      ...
      description: 'Exchange vows on our pristine white-sand beach with the turquoise ocean providing a breathtaking backdrop.',
    ...
    <div className="animate-in fade-in duration-700 bg-[#faf9f6]">
      ...
      <div className="relative h-[60vh] md:h-[80vh] -mx-6 md:-mx-12 lg:-mx-16 -mt-16 md:-mt-24 mb-16 md:mb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-stone-900/30 flex flex-col justify-end p-6 md:p-16 lg:p-24">
          <div className="max-w-7xl mx-auto w-full">
            ...
            <h1 className="text-4xl md:text-7xl lg:text-9xl font-serif text-white mb-6 leading-[0.9] tracking-tighter">Weddings</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-0">
        ...
        <div className="max-w-3xl mb-24">
          <h2 className="text-3xl md:text-5xl font-serif text-stone-900 mb-8 leading-tight">Your Dream Story Starts Here</h2>
        ...
        <div className="mb-32">
          <div className="flex items-center gap-4 mb-12">
            ...
            <h3 className="text-3xl font-serif text-stone-900">Picture Perfect Locations</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {locations.map((loc, i) => (
              <div key={i} className="group cursor-pointer">
                ...
                <h4 className="font-serif text-2xl mb-3 text-stone-900">{loc.title}</h4>
          ...
          <div className="bg-white rounded-[40px] md:rounded-[64px] shadow-2xl border border-stone-100 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-5">
              ...
              <div className="lg:col-span-2 bg-stone-900 p-8 md:p-20 text-white">
                <h3 className="text-3xl md:text-5xl font-serif mb-6 md:mb-8">Wedding Packages</h3>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-1 gap-3 md:gap-4">
                  {weddingPackages.map((pkg) => (
                    ...
                    >
                      <span className="font-serif text-lg md:text-xl">{pkg.name}</span>
              ...
              <div className="lg:col-span-3 p-8 md:p-20">
                <div className="flex items-center gap-3 mb-6 md:mb-8">
                  ...
                  <h4 className="text-2xl md:text-3xl font-serif text-stone-900">{activePackage} Package Inclusions</h4>
                </div>
                ...
                <div className="mt-8 md:mt-12 pt-8 md:pt-12 border-t border-stone-100 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8">
                  <div className="text-center md:text-left">
                    ...
                    <p className="text-3xl md:text-4xl font-serif text-stone-900">${weddingPackages.find(p => p.name === activePackage)?.price}++</p>
                  </div>
                  <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    <button 
                      onClick={() => handleAddToInquiry(activePackage, weddingPackages.find(p => p.name === activePackage)?.price || '')}
                      className="px-8 py-4 bg-emerald-600 text-white rounded-full text-[10px] md:text-xs font-bold uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-xl flex items-center justify-center gap-2"
                    >
                      <ShoppingBag size={14} />
                      Add to Inquiry
                    </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-32">
          <div className="bg-emerald-900 text-white p-12 md:p-20 rounded-[64px] relative overflow-hidden">
            <div className="relative z-10">
              <h3 className="text-4xl font-serif mb-8">Perfection in Details</h3>
              <p className="text-emerald-100 text-lg font-light leading-relaxed mb-10">
                Your dedicated wedding planner will take care of all the necessary arrangements to make your ceremony perfect. Carefully listening to your needs and requirements, we will make sure that your wedding at Ayada Maldives will not only fulfill, but exceed your wedding dreams.
              </p>
          ...
          <div className="bg-stone-200 p-12 md:p-20 rounded-[64px] relative overflow-hidden group">
            ...
            />
            <div className="relative z-10">
              <h3 className="text-4xl font-serif text-stone-900 mb-8">Photography Services</h3>
              <p className="text-stone-600 text-lg font-light leading-relaxed mb-10">
                Every smile, every detail, every glance — beautifully captured to last a lifetime. Explore our photography brochure and discover how we can turn your special moments into timeless memories.
              </p>
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-serif text-stone-900 mb-4">Enhance Your Experience</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-10 rounded-[40px] border border-stone-100 shadow-sm">
                <h4 className="font-serif text-2xl mb-6 text-stone-900">{section.title}</h4>
