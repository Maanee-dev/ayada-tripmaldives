  ...
  return (
    <div className="animate-in fade-in duration-700 bg-[#f8f7f4]">
      ...
      <div className="relative h-[60vh] md:h-[70vh] -mx-6 md:-mx-12 lg:-mx-16 -mt-16 md:-mt-24 mb-16 md:mb-24 overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1573843225103-5006d9943129?auto=format&fit=crop&q=80&w=2000" 
        ...
        <div className="absolute inset-0 bg-stone-900/40 flex flex-col justify-end p-6 md:p-16 lg:p-24">
          <div className="max-w-7xl mx-auto w-full">
            ...
            <h1 className="text-4xl md:text-7xl lg:text-9xl font-serif text-white mb-6 leading-[0.9] tracking-tighter">Plan Your Indulgence</h1>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-32">
          <div className="lg:col-span-2">
            ...
            <p className="text-stone-600 text-lg font-light leading-relaxed mb-12">
              {activeTab === 'crystal' 
                ? "Our Crystal package is designed for a seamless and indulgent holiday, covering all your essentials from gourmet buffet dining to premium beverages and a wide array of island activities."
            ...
            <div className="space-y-16">
              ...
              <section>
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-2xl font-serif text-stone-900">Dining Experiences</h3>
                </div>
              ...
              <section>
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-2xl font-serif text-stone-900">Bar & Lounge</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <section>
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-2xl font-serif text-stone-900">Activities & Entertainment</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-8">
            <div className="bg-stone-900 text-white p-8 rounded-[32px] shadow-xl">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="font-serif text-xl">Arrival & Departure</h4>
              </div>
            ...
            <div className="bg-white p-8 rounded-[32px] border border-stone-100 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="font-serif text-xl text-stone-900">In Villa Experience</h4>
              </div>
              <ul className="space-y-4">
            ...
            <div className="bg-emerald-50 p-8 rounded-[32px] border border-emerald-100">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="font-serif text-xl text-emerald-900">Validity</h4>
              </div>
