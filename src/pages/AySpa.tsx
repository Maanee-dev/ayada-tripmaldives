...
import { Waves, CheckCircle2, Heart, Wind, ShieldCheck, Star, Clock, Sparkles, Droplets, Coffee, Bath, User, Sun, ShoppingBag } from 'lucide-react';
    ...
    <div className="animate-in fade-in duration-700 bg-[#fdfcfb]">
      ...
      <div className="relative h-[60vh] md:h-[80vh] -mx-6 md:-mx-12 lg:-mx-16 -mt-16 md:-mt-24 mb-16 md:mb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-stone-900/30 flex flex-col justify-end p-6 md:p-16 lg:p-24">
          <div className="max-w-7xl mx-auto w-full">
            ...
            <h1 className="text-4xl md:text-7xl lg:text-9xl font-serif text-white mb-4 md:mb-6 leading-[0.9] tracking-tighter">AySpa</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 mb-24 md:mb-32 items-center">
          <div>
            <h2 className="text-3xl md:text-5xl font-serif mb-6 md:mb-8 leading-tight text-stone-900">A 3500 sqm Sanctuary for the Soul</h2>
        ...
        <div className="mb-24 md:mb-32">
          <div className="bg-stone-900 text-white rounded-[40px] md:rounded-[64px] p-8 md:p-20 overflow-hidden relative">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center relative z-10">
              <div>
                <h3 className="text-3xl md:text-5xl font-serif mb-6 md:mb-8">Beautiful Relaxation Area</h3>
                <p className="text-stone-400 text-base md:text-lg font-light leading-relaxed mb-8 md:mb-10">
                  Your spa experience does not end after finishing your treatment. You are more than welcome to enjoy our beautiful relaxation area with heated and cold plunge pools, steam rooms and saunas separately for female and male guests.
                </p>
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                <img src="https://images.unsplash.com/photo-1560750588-73207b1ef5b8?auto=format&fit=crop&q=80&w=600" className="rounded-2xl md:rounded-3xl h-48 md:h-64 w-full object-cover" alt="Plunge Pool" referrerPolicy="no-referrer" />
                <img src="https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&q=80&w=600" className="rounded-2xl md:rounded-3xl h-48 md:h-64 w-full object-cover mt-6 md:mt-8" alt="Sauna" referrerPolicy="no-referrer" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-serif text-stone-900 mb-4">Treatment Suites</h3>
        ...
        <div className="mb-24 md:mb-32">
          <div className="bg-white rounded-[40px] md:rounded-[64px] shadow-2xl border border-stone-100 overflow-hidden">
            <div className="bg-stone-900 p-10 md:p-20 text-center text-white">
              <h3 className="text-3xl md:text-6xl font-serif mb-4 md:mb-6">AySpa Treatment Menu</h3>
                ...
                {menuCategories.find(c => c.name === activeCategory)?.items.map((item, i) => (
                  <div key={i} className="flex justify-between items-start md:items-center border-b border-stone-100 pb-4 group gap-4">
                    <div className="flex-1">
                      <h4 className="font-serif text-lg md:text-xl text-stone-900 group-hover:text-emerald-600 transition-colors leading-tight">{item.name}</h4>
                      <p className="text-stone-400 text-[9px] md:text-[10px] uppercase tracking-widest font-bold mt-1">{item.duration}</p>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="text-stone-900 font-serif text-lg md:text-xl whitespace-nowrap">
                        <span className="text-[10px] md:text-xs text-stone-400 font-sans mr-1">US$</span>
                        {item.price}
                      </div>
                      <button 
                        onClick={() => handleAddToInquiry(item)}
                        className="p-2 bg-stone-50 text-stone-400 hover:bg-emerald-600 hover:text-white rounded-full transition-all"
