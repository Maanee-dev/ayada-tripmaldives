  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
      <div className="mb-12 border-b border-stone-100 pb-8">
        ...
        <h1 className="text-4xl md:text-6xl font-serif text-stone-900 mb-4">{title}</h1>
        <p className="text-stone-400 text-xs uppercase tracking-widest">Last Updated: {lastUpdated}</p>
      </div>
      <div className="prose prose-stone max-w-none prose-headings:font-serif prose-headings:font-normal prose-p:text-stone-600 prose-p:leading-relaxed prose-li:text-stone-600">
        {children}
      </div>
