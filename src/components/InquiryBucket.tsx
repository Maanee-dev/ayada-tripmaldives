          ...
          <>
            ...
            >
              ...
              <div className="p-6 border-bottom border-stone-100 flex justify-between items-center bg-stone-50">
                <div>
                  <h3 className="text-xl font-serif text-stone-900">Inquiry Bucket</h3>
              ...
              <div className="flex-1 overflow-y-auto p-6">
                ...
                {step === 'form' && (
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button 
                        type="submit"
                        className="flex-[2] py-4 bg-stone-900 text-white rounded-xl font-bold text-xs uppercase tracking-[0.2em] hover:bg-emerald-600 transition-all shadow-xl flex items-center justify-center gap-2"
                      >
                        <Send size={14} />
                        Send Bulk Inquiry
                      </button>
                ...
                {step === 'success' && (
                  <div className="h-full flex flex-col items-center justify-center text-center p-6">
                    ...
                    <h3 className="text-2xl font-serif text-stone-900 mb-4">Inquiry Sent!</h3>
